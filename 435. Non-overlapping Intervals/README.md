...
<pre style="position: relative;"><strong>Input:</strong> intervals = [[1,2],[2,3],[3,4],[1,3]]
...
<pre style="position: relative;"><strong>Input:</strong> intervals = [[1,2],[1,2],[1,2]]
...
<pre style="position: relative;"><strong>Input:</strong> intervals = [[1,2],[2,3]]
