<div class="elfjS" data-track-load="description_content"><p>You are given two integers, <code>num</code> and <code>t</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> num = 4, t = 1
...
<pre style="position: relative;"><strong>Input:</strong> num = 3, t = 2
